<meta charset="utf-8">
<title><?php echo $webname['value']; ?></title>
<meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="小说" />
<meta name="author" content="h1902" />
<meta property="og:image" content="<?php echo HOME_ASSETS_PATH . "/" . $logo['value']; ?>" />
...
<link rel="icon" href="<?php echo ADMIN_ASSETS_PATH . "/" . $logo['value']; ?>" type="image/jpeg">
<link rel="shortcut icon" href="<?php echo ADMIN_ASSETS_PATH . "/" . $logo['value']; ?>" type="image/jpeg">
